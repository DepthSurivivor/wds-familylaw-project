    ...
    <section id="demo" className="py-24 px-6 bg-[#FAFAFA]">
      <div className="max-w-[800px] mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-[36px] md:text-[48px] font-bold text-black tracking-[-0.03em] mb-4">Testing Interface</h2>
          <p className="text-[18px] text-slate-500 font-light max-w-[600px] mx-auto">
            Experience how our intake assistant structures inquiries. Enter a sample case to see the output format.
          </p>
        </div>
          ...
          <AnimatePresence mode="wait">
            {step === 'intro' && (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-[24px] font-semibold text-black tracking-tight">Simulate Intake</h3>
                    <p className="text-slate-500 text-[14px]">Provide basic details to generate a structured case file.</p>
                  </div>
                </div>
                  ...
                  >
                    {isInitializing ? (
                      <>
                        ...
                        <span>Submission in progress...</span>
                      </>
                    ) : (
            ...
            {step === 'simulating' && (
              ...
              >
                ...
                <h3 className="text-[20px] font-semibold text-black mb-2 tracking-tight">Processing Simulated Call...</h3>
                <p className="text-slate-500 text-[14px]">Structuring narrative into actionable data.</p>
              </motion.div>
            )}
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-6 border-b border-black/5 gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-[20px] font-semibold text-black tracking-tight">Intake Captured</h3>
                ...
                <div className="bg-[#1E1E1E] rounded-2xl p-6 md:p-8 font-mono text-[13px] leading-[1.6] overflow-x-auto shadow-inner border border-black/10">
                  <div className="text-emerald-400 mb-4">{`// EXTRACTED_CASE_DATA`}</div>
                  <div className="text-slate-300">
                    <span className="text-purple-400">"status"</span>: <span className="text-amber-300">"Urgent Review"</span>,<br/>
                    ...
                    <span className="text-purple-400">"case_category"</span>: <span className="text-green-300">"Family Law - Assessment Needed"</span>,<br/>
                    <span className="text-purple-400">"client_sentiment"</span>: <span className="text-green-300">"Anxious / Seeking counsel"</span>,<br/>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-black/5 pt-8">
                  <div className="flex items-center gap-2 text-slate-500 font-semibold text-[13px] uppercase tracking-widest bg-slate-50 px-4 py-2 rounded-lg border border-black/5">
                    <FileJson className="w-4 h-4" /> CRM Synced
                  </div>
