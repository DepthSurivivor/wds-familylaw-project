...
const SCENARIOS: ScenarioConfig[] = [
  {
    ...
    events: [
      { time: 0.8, type: 'signal', label: 'Call connected', status: 'listening' },
      { time: 4.2, type: 'field', field: 'name', value: 'Danielle Brooks', label: 'Name identified' },
      { time: 9.6, type: 'field', field: 'phone', value: '(312) 555-0187', label: 'Phone captured' },
      { time: 13.1, type: 'field', field: 'email', value: 'danielle.brooks@email.com', label: 'Email captured' },
      { time: 17.9, type: 'signal', label: 'Matter being classified', status: 'extracting' },
      { time: 22.4, type: 'field', field: 'matterType', value: 'Child Custody Modification', label: 'Matter classified' },
      { time: 31.5, type: 'field', field: 'urgency', value: 'High — hearing scheduled within 5 days', label: 'Urgency detected' },
      {
        time: 39.2,
        type: 'field',
      ...
      },
      {
        ...
        field: 'notes',
        value:
          'Caller was served with a motion to modify custody and needs immediate guidance before an upcoming hearing.',
        label: 'Context summary drafted',
      },
      { time: 61, type: 'signal', label: 'Building recommendation', status: 'reviewing' },
      {
        time: 69.8,
        type: 'field',
        field: 'nextStep',
        value: 'Route to priority intake queue for same-day callback and consultation scheduling.',
      ...
      },
      {
        ...
        type: 'field',
        field: 'status',
        value: 'Qualified — ready for staff follow-up',
  ...
  },
  {
    ...
    finalBadge: 'Ready for Staff Follow-Up',
    events: [
      { time: 1.1, type: 'signal', label: 'Call connected', status: 'listening' },
      { time: 6.3, type: 'field', field: 'name', value: 'Melissa Grant', label: 'Name identified' },
      { time: 11.8, type: 'field', field: 'phone', value: '(404) 555-0122', label: 'Phone captured' },
      { time: 18.6, type: 'signal', label: 'Caller distress detected', status: 'extracting' },
      {
        time: 24.1,
        type: 'field',
        field: 'matterType',
        value: 'Separation and child support guidance',
        label: 'Matter classified',
      },
      { time: 33.2, type: 'field', field: 'email', value: 'm.grant@outlook.com', label: 'Email captured' },
      {
        time: 44.7,
        type: 'field',
        field: 'urgency',
        value: 'Moderate — caller anxious, requests prompt guidance',
      ...
      },
      {
        ...
        type: 'field',
        field: 'representationStatus',
        value: 'No attorney retained yet',
        label: 'Representation status updated',
      },
      {
        time: 63.5,
        ...
        field: 'notes',
        value:
          'Caller is uncertain about immediate legal options after separation and wants a clear explanation of next steps for support and parenting time.',
        label: 'Context summary drafted',
      },
      { time: 73, type: 'signal', label: 'Preparing guided recommendation', status: 'reviewing' },
      {
        time: 82,
        type: 'field',
        field: 'nextStep',
        value: 'Schedule guided consultation call with intake specialist within one business day.',
        label: 'Next step prepared',
      },
      {
        time: 89,
        type: 'field',
        field: 'status',
        value: 'Guided consult recommended — staff callback needed',
        label: 'Intake completed',
      },
    ],
  },
